<x-guest-layout>
    <div class="mb-10 text-center">
        <h2 class="text-3xl font-black tracking-tight text-slate-800">Daftar Akun</h2>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <div class="space-y-1.5">
            ...
            <div class="relative group">
                ...
                <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus placeholder="Masukkan nama Anda"
                    class="block w-full pl-12 pr-4 py-3.5 bg-slate-50 border-transparent rounded-2xl text-sm font-bold text-slate-700 placeholder-slate-400 focus:bg-white focus:border-[#2ee0a7] focus:ring-4 focus:ring-[#2ee0a7]/10 transition-all duration-300">
            </div>
        ...
        <div class="space-y-1.5">
            ...
            <div class="relative group">
                ...
                <input id="password_confirmation" type="password" name="password_confirmation" required placeholder="Masukkan Kata Sandi"
                    class="block w-full pl-12 pr-4 py-3.5 bg-slate-50 border-transparent rounded-2xl text-sm font-bold text-slate-700 placeholder-slate-400 focus:bg-white focus:border-[#2ee0a7] focus:ring-4 focus:ring-[#2ee0a7]/10 transition-all duration-300">
            </div>
