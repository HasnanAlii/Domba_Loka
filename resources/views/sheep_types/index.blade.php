                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                                <div class="relative flex justify-center" x-data="{ open: false }">
                                                    ...
                                                    <div x-show="open"
                                                        ...
                                                        <form action="{{ route('sheep-types.destroy', $type) }}" method="POST"
                                                            data-confirm-message="Apakah Anda yakin ingin menghapus jenis domba ini? Seluruh data domba dengan jenis ini akan terpengaruh.">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
