                ...
                <div class="p-6 lg:p-10">
                    <form action="{{ $action }}" method="POST">
                        ...
                        <div class="mt-8 flex items-center justify-end gap-4 border-t border-slate-100 pt-6">
                            <a href="{{ route('suppliers.index') }}" class="px-6 py-3 border border-slate-200 rounded-2xl bg-transparent hover:bg-slate-50/50 text-center font-medium text-slate-500 transition-colors hover:text-slate-700">Batal</a>
