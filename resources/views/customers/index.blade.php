                ...
                <div class="bg-white shadow-xl shadow-slate-200/60 rounded-3xl overflow-hidden border border-slate-100">
                    <div class="p-6 lg:p-10">
                        ...
                        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-6">
                            <div>
                                <h3 class="text-xl font-bold text-slate-800">Daftar Pelanggan</h3>
                                <p class="text-sm text-slate-500 mt-1">Kelola data pelanggan sistem Anda.</p>
                            </div>
                                        ...
                                        <tr class="group hover:bg-blue-50/40 transition-colors duration-200">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                                <div class="flex justify-center items-center gap-2">
                                                    ...
                                                    {{-- DELETE --}}
                                                    <form action="{{ route('customers.destroy', $customer) }}" method="POST" class="inline" data-confirm-message="Apakah Anda yakin ingin menghapus pelanggan ini?">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" 
                                            ...
                                            <tr>
                                                <td colspan="6" class="px-6 py-16 text-center">
                                                    <div class="flex flex-col items-center justify-center">
                                                        ...
                                                        <h3 class="text-lg font-semibold text-slate-700">Tidak ada pelanggan ditemukan</h3>
                                                        <p class="text-sm text-slate-500 max-w-xs mx-auto mt-1">Silakan tambahkan data pelanggan baru.</p>
                                                        <a href="{{ route('customers.create') }}" class="mt-4 text-sm text-blue-600 hover:text-blue-800 font-medium hover:underline">
                                                            + Tambah Pelanggan
                                                        </a>
                                                    </div>
                                                </td>
