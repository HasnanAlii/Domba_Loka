    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <nav class="flex text-sm font-medium text-gray-500">
                ...
                <a href="{{ route('customers.index') }}" class="hover:text-blue-600 cursor-pointer transition">Pelanggan</a>
                <span class="mx-2">/</span>
    ...
    <div class="py-12  bg-[#f0f6ff] min-h-screen px-10">
        <div class="mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="relative">
                            ...
                            <div class="space-y-4">
                                <div class="flex flex-col border-b border-slate-100 pb-3">
                                    ...
                                    <span class="text-slate-700 font-medium">{{ $customer->phone }}</span>
                                </div>
                                <div class="flex flex-col border-b border-slate-100 pb-3">
                                ...
                                <div class="flex flex-col border-b border-slate-100 pb-3">
                                    ...
                                    <span class="text-slate-700 font-medium leading-relaxed">{{ $customer->address ?? '-' }}</span>
                                </div>
                                <div class="flex flex-col pb-3">
                                    <span class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1">Terdaftar Pada</span>
                                    <span class="text-slate-700 font-medium">{{ $customer->created_at->format('d/m/Y H:i') }}</span>
                                </div>
                            </div>
                            ...
                            <div class="mt-6 flex items-center gap-3">
                                ...
                                <form action="{{ route('customers.destroy', $customer) }}" method="POST" class="flex-1" data-confirm-message="Apakah Anda yakin ingin menghapus pelanggan ini?">
                                    @csrf
                                    @method('DELETE')
                ...
                {{-- RIGHT COLUMN: TRANSACTIONS RECORD --}}
                        ...
                        <div class="p-6 lg:p-8">
                            ...
                            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                                <div>
                                    ...
                                    <p class="text-sm text-slate-500 mt-1">Daftar transaksi yang dilakukan oleh {{ $customer->name }}.</p>
                                </div>
                            </div>
